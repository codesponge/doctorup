...
The variety of languages supported and the ability to create custom themes are what lead to my choosing ultraviolet for syntax highlighting despite the install issues. (more on in install)

h3. Intention

DoctorUp is designed with the intention of being a useful tool in marking up languages like textile, markdown etc.. that may or may not contain snippets of code that deserve syntax highlighting.  It should perform it's job and pass the results on.
...
h3. 1st. Get ultraviolet installed

See this post about installing ultraviolet. [[LINK]]--coming soon
