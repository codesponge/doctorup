...
That may have sounded complex but it is really pretty simple and it didn't take long to implement.  I want to implement better clues for caching, and more thorough tests before it releases.  (if you are a cache master, and want to help let me know!)
